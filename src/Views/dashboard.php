...
?>
  ...
  <main id="main" class="main">
    ...
    <section id="hero" class="hero section light-background">
      ...
      <img src="/sistema/src/Views/assets/img/hero-bg.jpg" alt="" data-aos="fade-in">

      <div class="container position-relative">

        <div class="welcome position-relative" data-aos="fade-down" data-aos-delay="100">
          <h2>BIENVENIDO A MEDILAB</h2>
          <p>Una vida saludable, es la base de una vida plena</p>
        </div><!-- End Welcome -->
        ...
        <div class="content row gy-4">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="why-box" data-aos="zoom-out" data-aos-delay="200">
              ...
              <p>
                En Medilab, combinamos experiencia médica, tecnología avanzada y un trato humano para ofrecerte la mejor atención. Tu salud es nuestra prioridad.
                Agenda una cita hoy mismo y descubre por qué somos la mejor opción para el cuidado de tu salud.
              </p>
              ...
              <div class="row gy-4">
                ...
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box" data-aos="zoom-out" data-aos-delay="300">
                    ...
                    <p>Ofrecemos una amplia gama de servicios médicos, incluyendo 
                        consultas generales, exámenes de laboratorio, imágenes diagnósticas 
                        y especialidades médicas. Todo en un solo lugar para tu comodidad.</p>
                  </div>
                </div><!-- End Icon Box -->
                ...
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box" data-aos="zoom-out" data-aos-delay="400">
                    ...
                    <p>Nuestra misión es proporcionar servicios médicos integrales, accesibles y de alta calidad, promoviendo el bienestar físico y emocional de nuestros pacientes.</p>
                  </div>
                </div><!-- End Icon Box -->
                ...
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box" data-aos="zoom-out" data-aos-delay="500">
                    ...
                    <p>Ser reconocidos como la clínica líder en atención médica personalizada, innovadora y humana, comprometida con la salud y el bienestar de la comunidad</p>
                  </div>
                </div><!-- End Icon Box -->
