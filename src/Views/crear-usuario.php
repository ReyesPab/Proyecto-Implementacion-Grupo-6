            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="formCrearUsuario">
                        <div class="row">
                            <!-- MODIFICACIÓN: Campo Número de Identidad solo acepta números -->
                            ...
                            <!-- MODIFICACIÓN: Campo Usuario solo acepta letras -->
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="row">
                            ...
                            <!-- MODIFICACIÓN: Validación de correo único -->
                            <div class="col-md-6 mb-3">
                                <label for="correo_electronico" class="form-label">Correo Electrónico</label>
                                <input type="email" class="form-control" id="correo_electronico" name="correo_electronico" 
                                       maxlength="50" onblur="crearUsuario.validarEmailUnico(this)"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <!-- MODIFICACIÓN: Botón autogenerar contraseña con validaciones -->
                                <button type="button" class="btn btn-outline-primary" onclick="crearUsuario.autogenerarPassword()">
...
<script>
    class CrearUsuario {
        ...
        // MODIFICACIÓN: Función para autogenerar contraseña robusta
        ...
        // MODIFICACIÓN: Validar correo único en base de datos
    ...
    try {
        ...
        // SOLUCIÓN CORRECTA: Verificar por status 201 (como devuelve el controlador)
        if (result.status === 201) {
            ...
            // Redirigir a gestión de usuarios
