...
class userController {
    ...
    public function crearUsuario() {
        ...
        // Encriptar la contraseña antes de guardar (usar createPassword en Security)
        // Nota: $password ya fue validada arriba
        $this->data['contraseña'] = Security::createPassword($password);
 ...
 // Agregar después del método verificarIdentidad()

// Verificar disponibilidad de correo electrónico (AJAX)
public function verificarCorreo() {
    ...
    $existe = userModel::correoExiste($this->data['correo'], $excludeId);
...
public function obtenerBitacora() {
    ...
    // Actualizar usuario
// Actualizar usuario - VERSIÓN COMPLETA
...
public function obtenerUsuarioCompleto() {
    ...
    // DEBUG: Log para verificar estructura
    error_log("DEBUG obtenerUsuarioCompleto - Usuario obtenido: " . print_r($usuario, true));
